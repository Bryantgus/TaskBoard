      ...
      <div className="flex flex-col mt-5">
        ...
        <div className="flex flex-col mt-5">
          ...
          <div className="flex justify-end gap-4">
            ...
            <div onClick={() => saveTask(idTaskRef.current, "delete")} className="cursor-pointer rounded-[20px] w-[120px] h-[35px] flex justify-center items-center gap-2 text-neutral-100 text-[14px]" style={{backgroundColor: "#97A3B6"}}>
              <span>Delete</span>
              <img src={trash} className="w-[20px] h-[20px]" alt="" />
            </div>

            <div onClick={() => saveTask({title, description, selectedIcon, selectedStatus, idTaskRef}, "save")} className="cursor-pointer rounded-[20px] w-[120px] h-[35px] flex justify-center items-center gap-2 text-neutral-100 text-[14px]" style={{backgroundColor: "#3662E3"}}>
              <span>Save</span>
