...
const TaskItem = React.memo(({ bgItem, emoji, bgEmoji, stateTask, bgStateTask, title, description, fontSize }) => {
    console.log("Render TaskItem");
    return (
        <div className="cursor-pointer grid w-[550px] h-auto rounded-[15px] grid-cols-[auto_400px_auto] justify-center items-center gap-x-4 p-4" style={{ backgroundColor: bgItem }}>
